    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        spinnerCategories.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(CreateTaskActivity.this, selectedItemName + " " + R.string.selected, Toast.LENGTH_SHORT).show();
            }
    ...
    private void dateTimeDialogBuilder() {
        ...
        buttonDateTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Create date dialog
                dateDialog = new DatePickerDialog(CreateTaskActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    ...
                    public void onDateSet(DatePicker datePicker, final int endYear, final int endMonth, final int endDay) {
                        timePicker = new TimePickerDialog(CreateTaskActivity.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
        ...
        buttonCreateTask.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if (taskName.trim().length() == 0) {
                    Toast.makeText(CreateTaskActivity.this, R.string.enter_task_name, Toast.LENGTH_SHORT).show();
                    return;
                }
                else if (memberList.size() <= 0) {
                    Toast.makeText(CreateTaskActivity.this, R.string.enter_team_member, Toast.LENGTH_SHORT).show();
                    return;
                }
